                ...
                product: {
                    ...
                    Service: {
                        DTinsight_API: {
                            ...
                            Group: 'default',
                            DependsOn: ['Insight_Gateway'],
                            Config: {
                                mail_from: {
                                    Default: '华彗数据产品技术支持',
                                    Desc: 'internal',
                                    Type: 'internal',
                                    Value: '华彗数据产品技术支持test'
                                },
                                mail_host: {
                                ...
                                mail_username: {
                                    Default: 'tech@huahuidata.com',
                                    Desc: 'internal',
                                    Type: 'internal',
                                    Value: 'tech@huahuidata.com'
                                },
                                mysql_ip: {
                                    Default: {
                                        Host: ['node1'],
                        ...
                        DTinsight_Batch: {
                            ...
                            Group: 'default',
                            DependsOn: ['Insight_Engine', 'Insight_Console'],
                            Config: {
                                engine_ip: {
                                    Default: {
                                        Host: ['node3'],
